...
import com.example.demo.library.util.DeepCopy;
import com.example.demo.library.util.Pair;
...
public class RequestContext extends ConcurrentHashMap<String, Object> {
    ...
    public RequestContext() {
        super();
        LOG.info("RequestContext constructor");
    }
    ...
    public boolean isGzipRequested() {
        final String requestEncoding = this.getRequest().getHeader(CustomHeaders.ACCEPT_ENCODING);
